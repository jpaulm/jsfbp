...
describe('collate', function () {
  it('should collate based on a single field', function () {
    ...
    var sender0 = network.defProc(MockSender.generator(['1,m1', '2,m2', '3,m3']));
    var sender1 = network.defProc(MockSender.generator(['1,d11', '1,d12', '2,d21', '3,d31', '3,d32', '3,d33', '4,d41']));
