...
describe('Network', function () {
  ...
  it('supports connecting IIPs via strings', function () {
    ...
    expect(network.getProcessPorts('foo')).to.eql({ "out": [], "in": ["bar"]});
  });
  ...
  it('supports connecting Processes via strings', function () {
    ...
    expect(network.getProcessPorts('bar')).to.eql({ "out": [], "in": ["in"]});
    ...
    expect(network.getProcessPorts('foo')).to.eql({ "out": ["out"], "in": []});
  });
});
