...
3. Execute `npm install`
   Install requires the following `npm` packages: `fibers`, `mocha`, `chai` and `mocha-fibers` - you may have to do `npm` installs for some or all of these.
...
9. Install requires the following `npm` packages: `fibers`, `mocha`, `chai` and `mocha-fibers` - you may have to do `npm` installs for some or all of these.
