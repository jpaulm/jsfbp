...
#Warning: 
A scheduling error was detected a week ago that had been introduced into JSFBP in June of this year.  We are working on fixing this, but meanwhile we will be resetting the code back to the state it was in in June.  Strangely enough the Travis CI tests did not detect any problem.  Sorry for the inconvenience - we will try to fix this as soon as possible. 
