...
var genss = network.defineProcess('./examples/components/genss.js', 'Gen');
var lbal = network.defineProcess('./components/lbal.js', 'LBal');
var passthru0 = network.defineProcess('./components/delay.js', 'passthru0');
var passthru1 = network.defineProcess('./components/delay.js', 'passthru1');
var passthru2 = network.defineProcess('./components/passthru.js', 'passthru2');
...
var recvr = network.defineProcess('./components/recvr.js');
...
if (!makeMergeSubstreamSensitive) {
  ...
  var ssmerge = network.defineProcess('./components/substreamsensitivemerge.js');
  var csws = network.defineProcess('./examples/components/checksequencewithinsubstreams.js');
  var passthruF = network.defineProcess('./components/delay.js', 'passthruF');
